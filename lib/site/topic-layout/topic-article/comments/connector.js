...
export default connect.defaults({
  ...
  commentsSync.setExpert(props.topic.tag.expert)
...
function commentsSyncFactory () {
  ...
  const sync = {
    ...
    sortByExpert (comments) {
      comments.sort((a, b) => a.author.id === params.expertId ? false : b.author.id === params.expertId ? true : false)
      return comments
    },
    ...
    all (body) {
      ...
      items = items.concat(sync.sortByExpert(body.results.comments))
